...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_userprofile', (
            ...
            ('timezone', self.gf('django.db.models.fields.CharField')(default='US/Mountain', max_length=50)),
        ))
    ...
    models = {
        ...
        'core.userprofile': {
            ...
            'timezone': ('django.db.models.fields.CharField', [], {'default': "'US/Mountain'", 'max_length': '50'}),
